          ...
          fun union (Empty, t1) = t1
            ...
            | union (t0 as Br(p0, m0, t00, t01), t1 as Br(p1, m1, t10, t11)) =
                if (m0 = m1) andalso (p0 = p1)
                  ...
                  (* prefix p0 contains p1, so merge t1 with a subtree of t0 *)
                  ...
                  (* prefix p1 contains p0, so merge t0 with a subtree of t1 *)
                  then if zeroBit(p0, m1)
                    then Br(p1, m1, union(t0, t10), t11)
                    else Br(p1, m1, t10, union(t0, t11))
